...
export class DrizzleOrganizationQuery implements OrganizationQueryPort {
  ...
  public async findDetail(id: OrganizationId): Promise<OrganizationDetailReadModel | null> {
    ...
    const infoDraft = {
      ...
      team: (s.infoDraft.team ?? { title: '', members: [] }) as OrganizationDetailReadModel['infoDraft']['team'],
    ...
    return {
      ...
      infoPublication: s.infoPublication
        ? {
            ...
            team: (s.infoPublication.team ?? { title: '', members: [] }) as OrganizationDetailReadModel['infoDraft']['team'],
