...
@Injectable()
export class RemoveRedirectSubscriptionInteractor {
  public constructor(
  ...
  public async execute(command: { boardId: BoardId; subscriptionId: BoardRedirectSubscriptionId }) {
    ...
    return this.txHost.startTransaction(async (tx) => {
      ...
      const result = BoardEntity.removeRedirectSubscription(state, {
