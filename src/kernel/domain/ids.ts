...
export type PostCommentId = EntityId<'PostComment'>;
export type PostReportId = EntityId<'PostReport'>;
export type CommentReportId = EntityId<'CommentReport'>;
...
export const PostId = createEntityId<PostId>();
export const PostCommentId = createEntityId<PostCommentId>();
export const PostReportId = createEntityId<PostReportId>();
export const CommentReportId = createEntityId<CommentReportId>();
