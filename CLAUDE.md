...
| `media` | Медиа-файлы (изображения, видео), S3-хранилище, видео-транскодирование (HLS), imgproxy |
| `cms` | Категории, типы, атрибуты — управление каталогом |
| `organization` | Организации, сотрудники, товары/услуги |
